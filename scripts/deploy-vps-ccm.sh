...
_ask_key "TWILIO_SENDER"             "Twilio numéro/expéditeur SMS (+324...)"
_ask_key "TWILIO_SENDERS"            "Twilio pool de numéros, séparés par virgules (optionnel, vide = TWILIO_SENDER)"
_ask_key "TWILIO_WEBHOOK_SIGNING_KEY" "Twilio Webhook Signing Key (voix + SMS)"
...
echo -e "${GREEN}╠═══════════════════════════════════════════════════════╣${NC}"
echo -e "${GREEN}║${NC}  Webhooks à configurer dans Twilio (par numéro) :  ${GREEN}║${NC}"
